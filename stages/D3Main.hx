...
var transferAB = getShader("Dglsl/shd_underwater");
	...
	// debugPrint(Paths.font("fnt_main.ttf"));
	susiCombo.font = Paths.font("fnt_main.ttf");
	...
	krisCombo.font = Paths.font("fnt_main.ttf");
	...
	ralsCombo.font = Paths.font("fnt_main.ttf");
	...
	wordCombo.font = Paths.font("fnt_main.ttf");
	wordCombo.cameras = [];
	wordCombo.alpha = 0.4;
	...
	maxCombo.font = Paths.font("fnt_main.ttf");
	...
	add(maxCombo);
	maxComboText.font = Paths.font("fnt_main.ttf");
	...
	SCORE.font = Paths.font("fnt_main.ttf");
	...
	add(SCORE);
	SCOREText.font = Paths.font("fnt_main.ttf");
